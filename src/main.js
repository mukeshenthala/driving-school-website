...
document.querySelector('#lead-form').addEventListener('submit', event => {
  ...
  if (channel === 'whatsapp') window.location.href = `https://wa.me/919000111622?text=${message}`
  else window.location.href = `mailto:saisandhyamotordrivingschool@gmail.com?subject=Sai%20Sandhya%20Driving%20School%20Enquiry&body=${message}`
})
